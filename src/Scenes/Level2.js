class Level2 extends Phaser.Scene {
    ...
    create() {
        this.map = this.add.tilemap("Project4Level2", 70, 70, 150, 25);
 
        this.tileset = this.map.addTilesetImage("Project4Level2", "tilemap_tiles_snow");
        ...
        my.sprite.player = this.physics.add.sprite(900, 1000, "platformer_characters", "tile_0000.png");
    ...
    showDialogue() {
        ...
        const npcText = "Nice job making it this far!\nThere are some angry mushroom men farther in.\nDon't get too close to them!";
